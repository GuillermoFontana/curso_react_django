...
function Navbar() {
    return (
            <nav className="w-full py-2 fixed z-50" style={{ backgroundColor: 'rgb(192, 183, 176)' }}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center space-x-6">
                            ...
                            <NavLink to="/distribuidores" className="text-sm text-gray-700 hover:text-black transition-transform duration-200 hover:scale-[1.03] inline-block">Distribuidores</NavLink>
